      ...
      <section className="bg-[#2c1a12] py-24 px-6 lg:px-32 text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="bg-transparent border-2 border-white text-white px-8 py-4 rounded flex flex-col items-center justify-center gap-2 min-w-[300px]">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-sm text-gray-300">+54 9 3541 577457</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white px-8 py-4 rounded shadow-lg hover:shadow-xl hover:-translate-y-1 transition duration-300 uppercase font-bold tracking-wider flex items-center justify-center gap-3 min-w-[200px]"
                >
                ...
                <span className="text-sm text-gray-300">@autor__libros</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#1877F2] text-white px-8 py-4 rounded shadow-lg hover:bg-[#166FE5] hover:-translate-y-1 transition duration-300 uppercase font-bold tracking-wider flex items-center justify-center gap-3 min-w-[200px]"
                >
                ...
                <span className="text-sm text-gray-300">villagustavoPRO</span>
              </div>
            </div>
          </div>
        </div>
